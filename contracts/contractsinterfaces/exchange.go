...
//
// Solidity: e LogCancelOrder(orderHash bytes32, buyToken address, buyAmount uint256, sellToken address, sellAmount uint256, expires uint256, nonce uint256, maker indexed address, tokenPairHash indexed bytes32)
...
//
// Solidity: e LogTrade(maker indexed address, taker indexed address, sellToken address, buyToken address, filledSellAmount uint256, filledBuyAmount uint256, paidFeeMake uint256, paidFeeTake uint256, orderHash bytes32, tradeHash bytes32, tokenPairHash indexed bytes32)
