...
//func (s *TradeService) triggerStopOrders(trades []*types.Trade) {
//	for _, trade := range trades {
//		stopOrders, err := s.OrderService.GetTriggeredStopOrders(trade.BaseToken, trade.QuoteToken, trade.PricePoint)
//
//		if err != nil {
//			logger.Error(err)
//			continue
...
//}
//
//func (s *TradeService) handleStopOrder(so *types.StopOrder) error {
//	o, err := so.ToOrder()
//
//	if err != nil {
//		logger.Error(err)
